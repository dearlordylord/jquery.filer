Due to jQuery.filer removed from support by CreativeDream and became an commercial plugin (with dropping of bower support as well) we have this repository for our project backward compartability. Legacy code uses this. We also have a right to user it because original software is under Apache License 2.0

To make it work, in bower.json use "jquery.filer": "...this repo address" instead of "jquery.filer": "^1.3.0".
